...
// Android-added: Split BulkPutBuffer.testPairs() into smaller test runs by JUnit Parameterized.
...
public class BulkPutBufferPairTest {
    ...
    public BulkPutBufferPairTest(BulkPutBuffer.BufferProxy bp, BulkPutBuffer.BufferProxy sbp) {
        this.bp = bp;
        this.sbp = sbp;
    }
    ...
    public void testPair() throws Throwable {
        BulkPutBuffer.testPairs(bp, sbp);
    }
}
