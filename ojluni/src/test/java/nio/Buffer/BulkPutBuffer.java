...
public class BulkPutBuffer {
    ...
    public static class BufferProxy {
        ...
        // Android-added: Add toString() method for splitting BulkPutBufferPairTest.
        @Override
        public String toString() {
            return elementType.getSimpleName() + "-" + kind + "-" +
                    (order == ByteOrder.LITTLE_ENDIAN ? "L" : "B");
        }
    }
    ...
    // Android-changed: Remove @Test and move the test invocations to PairsTest.
    // @Test(dataProvider = "proxyPairs")
    static void testPairs(BufferProxy bp, BufferProxy sbp) throws Throwable {
        for (int i = 0; i < ITERATIONS; i++) {
