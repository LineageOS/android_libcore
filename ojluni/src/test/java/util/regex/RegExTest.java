...
public class RegExTest {
    ...
    */
    ...
    // Android-changed: Disable stringBufferCheckAppendException() test due to app compat behavior.
    // @Test
    ...
    public static void unicodeCharacterNameTest() {
        ...
        for (int cp = 0; cp < Character.MAX_CODE_POINT; cp++) {
            ...
            String p1 = p;
            assertThrows(PatternSyntaxException.class, () -> Pattern.compile(p1));
            // class[c]
            p = "[\\N{" + Character.getName(cp) + "}]";
            // Android-changed: Android fails at the compilation time.
            // assertTrue(Pattern.compile(p).matcher(str).matches());
            String p2 = p;
            assertThrows(PatternSyntaxException.class, () -> Pattern.compile(p2));
        }
        ...
        for (int i = 0; i < 10; i++) {
            ...
            for (int cp = start; cp < end; cp++) {
                ...
                // Android-changed: Android fails at the compilation time.
                // assertTrue(Pattern.compile(p).matcher(str).matches());
                assertThrows(PatternSyntaxException.class, () -> Pattern.compile(p));
            }
    ...
    public static void linebreakTest() {
        ...
        // Android-changed: Disable failing backtracking test.
    ...
    public static void illegalRepetitionRange() {
        ...
        for (String rep : List.of("", "x", ".", ",", "-1", "2,1",
            ...
            var e = expectThrows(PatternSyntaxException.class, () ->
                    Pattern.compile(pat));
            // Android-changed: Android produces a different error message.
            // assertTrue(e.getMessage().startsWith("Illegal repetition"));
        }
    }

    // Android-changed: CANON_EQ flag isn't supported.
    // @Test
    ...
    // FIXME: Fix this test.
    // Android-changed: Disable lineBreakWithQuantifier test.
    // @Test
...
//          Map.entry("\\R{3,3}",  List.of(3)),            // 8258259
    ...
    // FIXME: Fix this test.
    // Android-changed: Disable caseInsensitivePMatch test.
    // @Test
    ...
    // FIXME: Fix this test.
    // Android-changed: Disable failing surrogatePairOverlapRegion() test.
    // @Test
