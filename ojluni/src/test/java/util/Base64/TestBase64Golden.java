...
public class TestBase64Golden {
    ...
    // BEGIN Android-added: reads content of a resource as a String array
    private static String[] readAllLines(String resourceName) throws Exception {
        try (InputStream is = TestBase64Golden.class.getResourceAsStream(resourceName)) {
            BufferedReader br = new BufferedReader(new InputStreamReader(is, DEF_CHARSET));
            return br.lines().toArray(String[]::new);
        }
    }
    // END Android-added: reads content of a resource as a String array
    ...
    public static void test0(Base64Type type, Encoder encoder, Decoder decoder,
        ...
        //                                         DEF_CHARSET)
        //                           .toArray(new String[0]);
        String[] srcLns = readAllLines(srcFile);
        String[] encodedLns = readAllLines(encodedFile);
        int lns = 0;
