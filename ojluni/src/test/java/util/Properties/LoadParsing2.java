...
public class LoadParsing2 {
    public static void main(String[] argv) throws Exception {
        for (int i = 0; i < dfiles.length; i++) {
            // Android-changed: investigate why these tests fail.
    ...
    private static void test(String fnData,
        ...
        throws Exception
    {
        // Android-changed: read data from resources.
        // File f = new File(System.getProperty("test.src", "."), fnData);
        // FileInputStream myIn = new FileInputStream(f);
        InputStream myIn = LoadParsing2.class.getResourceAsStream(fnData);
