...
public class XMLSaveLoadBasher {
        ...
        throws Exception
    {
        ...
        // Android-changed: create temp file.
        // File oldTestFile = new File("props3");
        // oldTestFile.delete();
        File oldTestFile = File.createTempFile("props3", "properties");

        // Save original
        System.err.println("Saving...");
        // Android-changed: read from the temp file.
        // try (OutputStream out = new FileOutputStream("props3")) {
        try (OutputStream out = new FileOutputStream(oldTestFile)) {
        ...
        try (InputStream in = new FileInputStream(oldTestFile)) {
            loadedProps.loadFromXML(in);
        }

        // Compare results
        // Android-removed: investigate failure.
