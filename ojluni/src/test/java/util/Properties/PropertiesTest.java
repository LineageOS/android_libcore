...
public class PropertiesTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LoadParsing();
        SaveEncoding();
        // Android-changed: current implementation fails to pass.
        // SaveLoadBasher();
        SaveSeparator();
        SaveClose();
        SaveComments();
    ...
    private static void LoadParsing() throws Exception {
        // Android-changed: read as resources.
        // File f = new File(System.getProperty("test.src", "."), "input.txt");
        // FileInputStream myIn = new FileInputStream(f);
        InputStream myIn = PropertiesTest.class.getResourceAsStream("input.txt");
