...
public class LoadAndStoreXML {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Android-removed: current implementation fails to read inputs with BOM.
        // testLoadAndStore("UTF-16BE", true);
        // testLoadAndStore("UTF-16LE", true);
        testLoadWithoutEncoding();
        // Android-removed: current implementation does not throw.
        ...
        // Android-removed: there is no security manager on Android.
        /*
