...
public class TestExtraTime {
    ...
    public static void main(String[] args) throws Throwable{
        // Android-removed: file is used for lastModified timestamp only.
        /*
        ...
        */
        ...
        for (byte[] extra : new byte[][] { null, new byte[] {1, 2, 3}}) {
            ...
            long time = 1676851259000L; // 20 Feb 2023 00:00 GMT
    ...
    static void test0(FileTime mtime, FileTime atime, FileTime ctime,
        ...
        // ZipFile
        // Android-changed: create file in a temp dir, 'test.dir' is not available.
        // Path zpath = Paths.get(System.getProperty("test.dir", "."),
        //                       "TestExtraTime.zip");
        Path zpath = Files.createTempDirectory("TestExtraTime").resolve("TestExtraTime.zip");
