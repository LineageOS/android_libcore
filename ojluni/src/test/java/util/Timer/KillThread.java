...
public class KillThread {
    ...
    // Android-added: AndroidJUnitRunner brings down an app on uncaught exception.
    private static final Thread.UncaughtExceptionHandler NO_OP_HANDLER = (t, e) -> {};
    ...
    public static void main (String[] args) throws Exception  {
        ...
        t.schedule(new TimerTask() {
            public void run() {
                // Android-added: we don't want this test to be killed after ThreadDeath is
                // thrown.
                Thread.setDefaultUncaughtExceptionHandler(NO_OP_HANDLER);
