...
public class EncodingTest {
    ...
    public Object[][] getParameters() throws IOException {
        ...
        // Android-changed: create files in temp directory, not in user.dir.
        File file1 = Files.createTempFile(  "ScannerCharsetTest1.txt", null).toFile();
        File file2 = Files.createTempFile( "ScannerCharsetTest2.txt", null).toFile();
