...
// Android-removed: CodeCacheOverflowProcessor is not available
// import test.java.lang.invoke.lib.CodeCacheOverflowProcessor;
import test.java.lang.invoke.remote.RemoteExample;

import java.lang.invoke.MethodHandle;
// Android-removed: not supported
...
public class MethodHandlesGeneralTest extends MethodHandlesTest {
    ...
    // Android-changed: test temporarily skipped due to b/236822435
    @Ignore
    ...
    // Android-removed: remove CodeCacheOverflowProcessor wrapper (not supported).
    // Android-changed: test temporarily skipped due to b/236817416
    @Ignore
    ...
    // Android-removed: remove CodeCacheOverflowProcessor wrapper (not supported).
    // Android-changed: test temporarily skipped due to b/236822443
    @Ignore
    ...
    // Android-removed: remove CodeCacheOverflowProcessor wrapper (not supported).
    // Android-changed: test temporarily skipped due to b/77634459
    @Ignore
    ...
    public void testFoldArguments() throws Throwable {
        // Android-changed: call test directly
    ...
    // Android-changed: method does not need to be public.
    ...
    // Android-removed: remove CodeCacheOverflowProcessor wrapper (not supported).
    // Android-changed: test temporarily skipped due to b/236823506
    @Ignore
...
// BEGIN Android-removed: MethodHandleProxies are not supported.
/*
    @Test
...
*/
// END Android-removed: MethodHandleProxies are not supported.
