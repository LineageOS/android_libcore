...
public class CountedCompleterTest {
     ...
     * sub-tasks on segments of the array. When a segment is of size 1, the action is applied to
     * that element, resolving the tasks. The resolve status then filters back to the top.
     */
